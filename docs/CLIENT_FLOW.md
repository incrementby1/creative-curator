...
Branch and cluster names are semantic tags edited in Inspector and survive reload/history. Project Map lists current structures and permits an accessible two-branch comparison of live ideas and decisions with state, evidence and assumptions, challenges, semantic relationships, and title-level differences. The comparison remains available in the mobile Project Map. Canvas arrangement remains unrelated.
